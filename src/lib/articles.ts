/**
 * Articles carried over from the previous surafel.work site so their links keep working.
 * Each article is a list of simple blocks.
 */

export type ArticleBlock =
  | { id: string; type: "paragraph" | "h2" | "quote"; content: string }
